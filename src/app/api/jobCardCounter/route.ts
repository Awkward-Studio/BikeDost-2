...
client
  ...
  .setProject("67f62681000d581fbd62") // Replace with your project ID
...
export async function POST(req: NextRequest) {
  try {
    ...
    const databaseId = "67f626df003d02582521"; // Replace with your database ID
    const collectionId = "67f628e20003cba867a2"; // Replace with your collection ID
